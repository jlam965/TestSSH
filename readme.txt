 ...
 This will deploy two artifacts, target/SampleApp.war and
 default-ds.xml.
 ...
 Now you can either deploy the target/SampleApp.war through the
 web-based GlassFish admininstration console, or you can again use asadmin:

  ./asadmin deploy target/SampleApp.war

 To undeploy the application, run:

  ./asadmin undeploy SampleApp
